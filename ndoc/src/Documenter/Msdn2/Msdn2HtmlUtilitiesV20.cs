...
namespace NDoc.Documenter.Msdn2
{
    ...
    class Msdn2HtmlUtilitiesV20
    {
        ...
        private static string FixLocalUrl(string line, string href, string filePath, int index)
        {
            ...
            {
                // JLD: 2006-03-29 - the following test give to many 
                // incorrect answers, since all files may not be created at this stage.
                // The urls that should be removed needs to be identified in antother fashion...
